					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> 144 Xuân Thủy, Cầu giấy, Hà Nội<br/>UET</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:Tien@gmail.com">Tien@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel: 88412345678">+8412345678</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Nightingale Jobs is a job portal, online job management system developed by Nguyen Dinh Chinh for OOAD course</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : 144 Xuan Thuy, University of Engineering and Technology</p>
                                <p>Email : <a href="mailto:nightingale.nath2@gmail.com">Tien@gmail.com</a></p>
                                <p>Phone : <a href="tel:+233546607474">+84123456</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Pham Van Tien</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Nguyen Dinh Chinh</a></li>
								</ul>
